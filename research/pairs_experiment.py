"""Pairs v1 experiment draft builder — frozen snapshot for registry.create()."""
...
from strategies.pairs.signal import PairsParams, default_params, params_to_dict
...
def build_pairs_experiment_draft(
    df: pd.DataFrame,
    *,
    label: str,
    ...
    snapshot = ExperimentSnapshot(
        ...
        universe=UniverseSpec(
            symbols=symbols,
            asset_class="equity",
            selection_rule="tradability_filters_top_liquidity_pair_candidates_recomputed_each_refit",
            filters={
                ...
                "sector_filter": "same_sector_if_available_else_all_vs_all",

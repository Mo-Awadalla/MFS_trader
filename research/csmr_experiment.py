"""CSMR experiment draft builder — frozen snapshot for registry.create()."""
...
from strategies.csmr.signal import CSMRParams, default_params, params_to_dict
from strategies.registry import strategy_template_version

STRATEGY_NAME = "cross_sectional_mean_reversion"
...
def build_csmr_experiment_draft(
    df: pd.DataFrame,
    *,
    label: str,
    ...
    """Build a registry-ready draft for canonical CSMR v1."""

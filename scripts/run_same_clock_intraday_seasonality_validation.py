"""Run SameClockIntradaySeasonalityETF-v1 validation on cached 30-minute bars."""
...
from research.same_clock_intraday_seasonality_pipeline import (
    format_same_clock_intraday_seasonality_gauntlet_report,
    run_same_clock_intraday_seasonality_validation_gauntlet,
)
from research.universes.same_clock_intraday_seasonality_v1 import all_symbols
from storage.parquet_io import read_bars

SYMBOLS = all_symbols()
DEFAULT_CACHE_DIR = Path("data/parquet/same_clock_intraday_seasonality/alpaca_sip")
DEFAULT_LABEL = "SameClockIntradaySeasonalityETF-v1-AlpacaSIP-30m-2021-2026"
DEFAULT_DATA_SOURCE = "alpaca_sip_static_same_clock_intraday_seasonality_v1_30m_cached"
DEFAULT_DATA_VERSION_PREFIX = "alpaca_sip_adjusted_30m_static_same_clock_intraday_seasonality_v1"
...
def main() -> int:
    ...
    print("SameClockIntradaySeasonalityETF-v1 validation: cached 30m bars")
    print(f"symbols={len(SYMBOLS)} {SYMBOLS}")
    print(f"cache_dir={cache_dir}")
    print(f"data_source={args.data_source}")
    print("strategy_rules=frozen from docs/strategy_sources/SameClockIntradaySeasonalityETF-v1.md")
    ...
    if failures:
        ...
        print("Use an existing compatible 30m cache with --cache-dir or add a downloader before validating.")
        return 2
    ...
    try:
        ...
        report = run_same_clock_intraday_seasonality_validation_gauntlet(
            panel,
            registry=registry,
            artifacts=artifacts,
        ...
        print(format_same_clock_intraday_seasonality_gauntlet_report(report))

"""Run ETF time-series momentum validation on cached daily ETF bars.
...
LABEL = "ETFTimeSeriesMomentumVolTarget-v1-Daily-2020-2026"
DATA_SOURCE = "alpaca_iex_static_etf_tsm_v1_cached"
...
def main() -> int:
    print("ETF time-series momentum vol-target validation")

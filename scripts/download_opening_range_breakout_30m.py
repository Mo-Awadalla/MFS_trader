"""Download 30-minute Alpaca bars for OpeningRangeBreakoutETF-v1."""
...
DEFAULT_STORAGE_DIR = Path("data/parquet/opening_range_breakout/alpaca_sip")
FREQUENCY = "30min"
...
def main() -> int:
    ...
    print("OpeningRangeBreakoutETF-v1 30m downloader")

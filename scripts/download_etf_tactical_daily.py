"""Download the static ETF tactical daily-bar universe.

Conservative API use: daily bars only, static seven-symbol universe, skip cached
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Download ETF tactical v1 daily bars")

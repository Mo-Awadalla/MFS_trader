"""Run OpeningRangeBreakoutETF-v1 validation on cached 30-minute bars."""
...
from research.opening_range_breakout_experiment import build_opening_range_breakout_experiment_draft
from research.opening_range_breakout_pipeline import (
    format_opening_range_breakout_gauntlet_report,
    run_opening_range_breakout_validation_gauntlet,
)
from research.universes.opening_range_breakout_v1 import all_symbols
from storage.parquet_io import read_bars

SYMBOLS = all_symbols()
DEFAULT_CACHE_DIR = Path("data/parquet/opening_range_breakout/alpaca_sip")
DEFAULT_LABEL = "OpeningRangeBreakoutETF-v1-AlpacaSIP-30m-2021-2026"
DEFAULT_DATA_SOURCE = "alpaca_sip_static_opening_range_breakout_v1_30m_cached"
DEFAULT_DATA_VERSION_PREFIX = "alpaca_sip_adjusted_30m_static_opening_range_breakout_v1"
...
def main() -> int:
    ...
    print("OpeningRangeBreakoutETF-v1 validation: cached 30m bars")
    print(f"symbols={len(SYMBOLS)} {SYMBOLS}")
    print(f"cache_dir={cache_dir}")
    print(f"data_source={args.data_source}")
    print("strategy_rules=frozen from docs/strategy_sources/OpeningRangeBreakoutETF-v1.md")
    ...
    if failures:
        ...
        print("Run: python scripts/download_opening_range_breakout_30m.py --feed sip")
        return 2
    ...
    try:
        ...
        report = run_opening_range_breakout_validation_gauntlet(
            panel,
            registry=registry,
            artifacts=artifacts,
        ...
        print(format_opening_range_breakout_gauntlet_report(report))

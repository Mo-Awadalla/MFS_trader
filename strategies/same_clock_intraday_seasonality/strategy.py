"""SameClockIntradaySeasonalityETF-v1 StrategyTemplate."""
...
class SameClockIntradaySeasonalityStrategy(StrategyTemplate[SameClockIntradaySeasonalityParams]):
    """Long-only 30-minute ETF same-clock intraday seasonality template."""

    name = "same_clock_intraday_seasonality"
    ...
    def default_params(self) -> SameClockIntradaySeasonalityParams:
        return default_params()

    def sweep_grid(self) -> list[SameClockIntradaySeasonalityParams]:
        return sweep_grid()

    def compact_sweep_grid(self) -> list[SameClockIntradaySeasonalityParams]:
    ...
    def diagnose_signals(
        ...
        return StrategyDiagnostics(
            ...
            rejected_by_reason={
                "insufficient_same_clock_history": int(
                    (signals[("portfolio", "skip_reason")] == "insufficient_same_clock_history").sum()
                ),
            ...
            extra={
                ...
                "hypothesis": "prior_same_clock_slot_mean_intraday_seasonality",
                "rebalance_rule": "same_clock_30m_slots_flat_by_close",
    ...
    def warmup_bars(self, params: SameClockIntradaySeasonalityParams | None = None) -> int:
    ...
    def metadata(self) -> dict[str, Any]:
        return {
            ...
            "strategy_template_version": self.strategy_template_version,
            "mode": "same_clock_intraday_seasonality_etf",
            "data_shape": "cross_sectional_intraday_etf_panel",
            "hypothesis": "prior_same_clock_slot_mean_intraday_seasonality",
    ...
    @staticmethod
    def params_from_dict(data: dict[str, object]) -> SameClockIntradaySeasonalityParams:
        return params_from_dict(data)


def get_strategy() -> SameClockIntradaySeasonalityStrategy:
    return SameClockIntradaySeasonalityStrategy()

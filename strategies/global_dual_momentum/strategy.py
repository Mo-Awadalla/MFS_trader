"""Global Dual Momentum Defensive StrategyTemplate."""
...
class GlobalDualMomentumStrategy(StrategyTemplate[GlobalDualMomentumParams]):
    """Long-only monthly global dual momentum defensive rotation template."""

    name = "global_dual_momentum"
    ...
    def default_params(self) -> GlobalDualMomentumParams:
        return default_params()

    def sweep_grid(self) -> list[GlobalDualMomentumParams]:
        return sweep_grid()

    def compact_sweep_grid(self) -> list[GlobalDualMomentumParams]:
    ...
    def diagnose_signals(
        ...
        return StrategyDiagnostics(
            ...
            extra={
                ...
                "hypothesis": "global_dual_momentum_risk_on_else_defensive",
    ...
    def warmup_bars(self, params: GlobalDualMomentumParams | None = None) -> int:
        params = params or self.default_params()
    ...
    def metadata(self) -> dict[str, Any]:
        return {
            ...
            "strategy_template_version": self.strategy_template_version,
            "mode": "global_dual_momentum_defensive",
            "data_shape": "cross_sectional_etf_panel",
            "hypothesis": "global_dual_momentum_risk_on_else_defensive",
    ...
    @staticmethod
    def params_from_dict(data: dict[str, object]) -> GlobalDualMomentumParams:
        return params_from_dict(data)


def get_strategy() -> GlobalDualMomentumStrategy:
    return GlobalDualMomentumStrategy()

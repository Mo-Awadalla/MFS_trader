"""ETF time-series momentum StrategyTemplate."""
...
class ETFTimeSeriesMomentumStrategy(StrategyTemplate[ETFTimeSeriesMomentumParams]):
    """Long-only ETF time-series momentum with volatility targeting template."""

    name = "etf_time_series_momentum"
    ...
    def default_params(self) -> ETFTimeSeriesMomentumParams:
        return default_params()

    def sweep_grid(self) -> list[ETFTimeSeriesMomentumParams]:
        return sweep_grid()

    def compact_sweep_grid(self) -> list[ETFTimeSeriesMomentumParams]:
    ...
    def diagnose_signals(
        ...
        return StrategyDiagnostics(
            ...
            extra={
                ...
                "hypothesis": "positive_12m_etf_time_series_momentum_inverse_vol_targeted",
    ...
    def warmup_bars(self, params: ETFTimeSeriesMomentumParams | None = None) -> int:
        params = params or self.default_params()
        return max(
    ...
    def metadata(self) -> dict[str, Any]:
        return {
            ...
            "long_only": True,
            "rebalance_rule": "first_trading_session_of_month",
            "source_memo": "docs/strategy_sources/ETFTimeSeriesMomentumVolTarget-v1.md",
    ...
    @staticmethod
    def params_from_dict(data: dict[str, object]) -> ETFTimeSeriesMomentumParams:
        return params_from_dict(data)


def get_strategy() -> ETFTimeSeriesMomentumStrategy:
    return ETFTimeSeriesMomentumStrategy()
